...
int lookupWord(char* lexeme) {
    ...
    if (strcmp(lexeme, "switch") == 0) return SWITCH_CODE;
    return IDENT; // Return IDENT if lexeme is not a reserved word
}
